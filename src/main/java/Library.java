...
public class Library {
   ...
   static String userInput;
    ...
    public static void addBook(){
        while (true){
            System.out.println("If you would like to add a book to your cart; type add. If not, type the title of the book to lookup the book. Type done if you are finished!");
